...
#     """Перечисление для представления возможных статусов заметки."""
#     NEW = "New"
...
#
#
# def create_note(title: str, content: str, status: NoteStatus = NoteStatus.NEW) -> dict:
...
#
#
# def change_status(note: dict, new_status: NoteStatus) -> dict:
#     """Изменяет статус заметки."""
#     note["status"] = new_status.value
#     return note
#
#
# def get_valid_status_from_user() -> NoteStatus:
#     """Запрашивает у пользователя новый статус заметки и валидирует его ввод."""
#     print("Available statuses:")
#     for status in NoteStatus:
#         print(f"- {status.value}")
#
#     while True:
#         user_input = input("Enter new status: ").strip()
#         try:
#             return NoteStatus(user_input)
#         except ValueError:
#             print("Invalid status. Please select one from the list.")
#
#
# def main():
...
#     display_note(note1)
#
#     new_status = get_valid_status_from_user()
#     note1 = change_status(note1, new_status)
#     print("\nUpdated note:")
#     display_note(note1)
#
#
